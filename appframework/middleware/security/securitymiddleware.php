...
namespace OCA\Calendar\AppFramework\Middleware\Security;
...
use OCA\Calendar\AppFramework\Http\RedirectResponse;
use OCA\Calendar\AppFramework\Utility\MethodAnnotationReader;
use OCA\Calendar\AppFramework\Middleware\Middleware;
