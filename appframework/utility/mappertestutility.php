...
namespace OCA\Calendar\AppFramework\Utility;
...
abstract class MapperTestUtility extends TestUtility {
	 ...
	 * @param \OCA\Calendar\AppFramework\Core\API $api the api mock
	 */
	protected function beforeEach(){
		$this->api = $this->getMock('\OCA\Calendar\AppFramework\Core\API', 
