...
<span class="utils">
	...
	<?php if ($_['calendar']['permissions'] & OCP\PERMISSION_CREATE) { ?>
		<a href="#" id="chooseCalendar-make-def" data-id="<?php p($_['calendar']['id']) ?>" title="<?php p($l->t('Make Default')) ?>" <?php OCP\Config::getUserValue(OCP\User::getUser(), 'calendar', 'defaultcalendar')==$_['calendar']['id']? p('class=icon-starred') : p('class=icon-star')?> ></a>
	<?php } ?>
