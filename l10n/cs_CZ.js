OC.L10N.register(
    ...
    "_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" : ["%n událost byla uložena v novém kalendáři %s.","%n události byly uloženy v novém kalendáři %s.","%n událostí bylo uloženo v novém kalendáři %s."],
    "_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" : ["%n událost byla uložena do kalendáře.","%n události byly uloženy do kalendáře.","%n událostí bylo uloženo do kalendáře."],
