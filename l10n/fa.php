...
"events have been saved in the new calendar" => "رویداد ها در تقویم جدید ذخیره شدند",
"Import failed" => "خطای وارد کردن",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n رویداد در تقویم جدید شما  %s ذخیره شد."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n رویداد در تقویم شما ذخیره شد."),
"New Timezone:" => "زمان محلی جدید",
"Timezone changed" => "زمان محلی تغییر یافت",
"Invalid request" => "درخواست نامعتبر",
"Calendar" => "تقویم",
"Error sending mail" => "خطا در ارسال ایمیل",
"Deletion failed" => "حذف کردن انجام نشد",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "آیا واقعا می‌خواهید این تقویم را حذف کنید؟",
"group" => "گروه",
...
"Interval is not valid. It must be a positive integer!" => "وقفه ها معتبر نسیتند. می باست عدد مثبت وارد کنید!",
"Import" => "ورودی دادن",
...
"Contacts' birthdays CalDAV address" => "آدرس CalDAV تاریخ تولد افراد",
