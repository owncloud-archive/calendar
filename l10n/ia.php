...
"events have been saved in the new calendar" => "eventos ha essite salveguardate in le nove calendario",
"Import failed" => "Il falleva importar",
"events have been saved in your calendar" => "eventos ha essite salveguardate in tu calendario",
"New Timezone:" => "Nove fuso horari",
"Timezone changed" => "Fuso horari cambiate",
"Invalid request" => "Requesta invalide.",
"Calendar" => "Calendario",
"Error sending mail" => "Error durante que on invia e-posta",
"Deletion failed" => "Il falleva deler",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Vermente tu vole deler iste calendario?",
"group" => "gruppo",
...
"Interval is not valid. It must be a positive integer!" => "Intervallo invalide.   Il debe esser un integer positive!",
