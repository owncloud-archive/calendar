OC.L10N.register(
    ...
    "events have been saved in the new calendar" : "sự kiện này đã được lưu vào lịch",
    "Import failed" : "Nhập vào thất bại",
    "events have been saved in your calendar" : "sự kiện này đã được lưu trong lịch của bạn",
    "New Timezone:" : "Múi giờ mới :",
    "Timezone changed" : "Thay đổi múi giờ",
    "Invalid request" : "Yêu cầu không hợp lệ",
    "Calendar" : "Lịch",
    "Error sending mail" : "Lỗi gửi mail",
    "Deletion failed" : "Xóa thất bại",
    "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" : "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
    "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" : "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
    "Do you really want to delete this calendar?" : "Bạn có thực sự muốn xóa lịch này?",
    "group" : "nhóm",
    ...
    "Interval is not valid. It must be a positive integer!" : "Thời gian không hợp lệ. Nó phải là một số nguyên dương!",
