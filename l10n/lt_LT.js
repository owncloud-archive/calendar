OC.L10N.register(
    ...
    "_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" : ["%n įvykis buvo išsaugoti naujame kalendoriuje %s","%n įvykiai buvo išsaugoti naujame kalendoriuje %n","%n įvykiai buvo išsaugoti naujame kalendoriuje %n"],
    "_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" : ["%n įvykis buvo išsaugoti tavo kalendoriuje.","%n įvykis buvo išsaugoti tavo kalendoriuje.","%n įvykiai buvo išsaugoti tavo kalendoriuje."],
