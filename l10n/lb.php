...
"events have been saved in the new calendar" => "Evenementer goufen an den neie Kalenner gespäichert",
"Import failed" => "Import feelgeschloen",
"events have been saved in your calendar" => "Evenementer goufen an däi Kalenner gespäichert",
"New Timezone:" => "Nei Zäitzon:",
"Timezone changed" => "Zäitzon geännert",
"Invalid request" => "Ongëlteg Aktioun",
"Calendar" => "Kalenner",
"Error sending mail" => "Feeler beim Schécke vun der Mail",
"Deletion failed" => "Läsche feelgeschloen",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Wëlls du dëse Kalenner sécher läschen?",
"group" => "Grupp",
...
"Interval is not valid. It must be a positive integer!" => "Interval ass net gëlteg. Et muss eng positiv ganz Zuel sinn!",
...
"You cannot add non-public events to a shared calendar." => "Du kanns keng net-ëffentlech Evenementer an de gedeelte Kalenner setzen.",
