...
"at" => "في",
"To" => "إلى",
"Your calendars" => "مفكراتك",
"Shared events" => "الأحداث المشاركة",
"General" => "عام",
...
"URLs" => "عناوين المواقع",
"Calendar CalDAV syncing addresses" => "عناوين CalDAV للتحديث التزامني للمفكرة",
"more info" => "المزيد من المعلومات",
"Primary address (Kontact et al)" => "العنوان الرئيسي (Kontact و غيرها)",
"iOS/OS X" => "iOS/OS X",
"Read only iCalendar link(s)" => "روابط iCalendar للقراءة فقط"
);
