...
"You do not have the permissions to edit this event." => "Vi ne permesatas redakti ĉi tiun okazaĵon.",
...
"events have been saved in the new calendar" => "okazaĵoj konserviĝis en via nova kalendaro",
"Import failed" => "Enporto malsukcesis",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n okazaĵo konserviĝis en la nova kalendaro %s.","%n okazaĵoj konserviĝis en la nova kalendaro %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n okazaĵo konserviĝis en via kalendaro.","%n okazaĵoj konserviĝis en via kalendaro."),
"New Timezone:" => "Nova horozono:",
"Timezone changed" => "La horozono estas ŝanĝita",
"Invalid request" => "Nevalida peto",
"Calendar" => "Kalendaro",
"Error sending mail" => "Eraris retpoŝtosendo",
...
"Do you really want to delete this calendar?" => "Ĉu vi certe volas forigi ĉi tiun kalendaron?",
"group" => "grupo",
...
"Interval is not valid. It must be a positive integer!" => "Intervalo ne validas. Ĝi devas esti pozitiva entjero!",
"Import" => "Enporti",
"Shared" => "Kunhavata",
"Error" => "Eraro",
...
"by" => "de",
"unnamed" => "nenomita",
"You do not have the permissions to update this calendar." => "Vi ne permesatas ĝisdatigi ĉi tiun kalendaron.",
"You do not have the permissions to delete this calendar." => "Vi ne permesatas forigi ĉi tiun kalendaron.",
"You do not have the permissions to add to this calendar." => "Vi ne permesatas aldoni al ĉi tiu kalendaro.",
"You do not have the permissions to add events to this calendar." => "Vi ne permesatas aldoni okazaĵojn al ĉi tiu kalendaro.",
"You cannot add non-public events to a shared calendar." => "Vi ne povas aldoni nepublikajn okazaĵon al kunhavata kalendaro.",
"You do not have the permissions to delete this event." => "Vi ne permesatas forigi ĉi tiun okazaĵon.",
"Busy" => "Okupita",
...
"Contacts' birthdays CalDAV address" => "CalDAV-adreso por naskiĝtagoj de kontaktoj",
