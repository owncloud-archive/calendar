OC.L10N.register(
    ...
    "events have been saved in the new calendar" : "hendingar lagra i den nye kalenderen",
    "Import failed" : "Feil ved importering",
    "events have been saved in your calendar" : "hendingar lagra i kalenderen",
    ...
    "Interval is not valid. It must be a positive integer!" : "Ugyldig intervall. Må vera positivt heiltal!",
    "Birthday" : "Bursdag",
    "Business" : "Forretning",
    "Call" : "Telefonsamtale",
    "Clients" : "Klientar",
    ...
    "You cannot add non-public events to a shared calendar." : "Du kan ikkje ha ikkje-offentlege hendingar i ein delt kalender.",
    "You do not have the permissions to delete this event." : "Du har ikkje tilgang til å sletta denne hendinga.",
    "Busy" : "Oppteken",
    "Show full event" : "Vil heile hendinga",
    "Show only busy" : "Berre vis oppteken",
    "Hide event" : "Skjul hendinga",
    ...
    "Location" : "Stad",
    "Categories (separate by comma)" : "Kategoriar (skilt med komma)",
    "Edit categories" : "Endra kategoriar",
    "Description" : "Skildring",
    "Export event" : "Eksporter hending",
    "Repeat" : "Gjenta",
    "Advanced" : "Avansert",
    ...
    "Visibility to people shared with" : "Vist til folk du deler med",
    ...
    "Create event" : "Opprett hending",
    "Share with user or group" : "Del med brukar eller gruppe",
    "Unshare" : "Udel",
    "Not shared with anyone" : "Ikkje delt med nokon",
    "Send Email" : "Send e-post",
    "Shared via calendar" : "Delt med kalender",
    "Not shared with anyone via calendar" : "Ikkje delt med nokon via kalenderen",
