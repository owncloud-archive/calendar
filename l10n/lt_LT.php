...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n įvykis buvo išsaugoti naujame kalendoriuje %s","%n įvykiai buvo išsaugoti naujame kalendoriuje %n","%n įvykiai buvo išsaugoti naujame kalendoriuje %n"),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n įvykis buvo išsaugoti tavo kalendoriuje.","%n įvykis buvo išsaugoti tavo kalendoriuje.","%n įvykiai buvo išsaugoti tavo kalendoriuje."),
...
"Share" => "Dalintis",
"Share with people on other ownClouds using the syntax username@example.com/owncloud" => "Dalintis su vartotoju kitame ownCloud debesyje, sintaksė username@example.com/owncloud",
...
"Contacts' birthdays CalDAV address" => "Kontaktų gimtadienių CalDAV nuoroda",
