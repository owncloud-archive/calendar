<?php
$TRANSLATIONS = array(
"Not all calendars are completely cached" => "Kaikkia kalentereja ei ole täysin tallennettu välimuistiin",
"Everything seems to be completely cached" => "Kaikki vaikuttaa olevan tallennettu välimuistiin",
...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n tapahtuma on tallennettu uuteen kalenteriin %s.","%n tapahtumaa on tallennettu uuteen kalenteriin %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n tapahtuma on tallennettu kalenteriisi.","%n tapahtumaa on tallennettu kalenteriisi."),
"New Timezone:" => "Uusi aikavyöhyke:",
"Timezone changed" => "Aikavyöhyke vaihdettu",
"Invalid request" => "Virheellinen pyyntö",
"Calendar" => "Kalenteri",
"Error sending mail" => "Virhe sähköpostia lähettäessä",
...
"Do you really want to delete this calendar?" => "Haluatko varmasti poistaa tämän kalenterin?",
"group" => "ryhmä",
...
"Contacts' birthdays CalDAV address" => "Yhteystietojen syntymäpäivien CalDAV-osoite",
