...
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d. MMMMta[ yyyy]{ – [ddd d.] MMMMta yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d. MMMMta[ yyyy] klo HH:mm{ – [ ddd d. MMMMta yyyy] klo HH:mm}",
"user" => "käyttäjä",
"group" => "ryhmä",
...
"dddd M/d" => "dddd d.M.",
"MMMM yyyy" => "MMMM yyyy",
"MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}" => "d. MMMMta[ yyyy]{ – d. [MMMMta ]yyyy}",
"dddd, MMM d, yyyy" => "dddd, d. MMMMta yyyy",
"Sunday" => "sunnuntai",
"Monday" => "maanantai",
"Tuesday" => "tiistai",
