...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("o evento %n foi gravado no novo calendário %s.","os eventos %n foram salvos no novo calendário %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("o evento %n foi salvo no seu calendário.","os eventos %n foram salvos no seu calendário."),
"New Timezone:" => "Novo fuso horário",
"Timezone changed" => "Fuso horário alterado",
"Invalid request" => "Requisição Inválida",
"Calendar" => "Calendário",
"Error sending mail" => "Erro ao enviar email",
"Deletion failed" => "Remoção falhou",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ -[ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Você realmente quer eliminar este calendário?",
"group" => "grupo",
...
"Contacts' birthdays CalDAV address" => "Endereço  CalDAV de aniversários dos contatos",
