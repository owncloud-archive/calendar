...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n evento è stato salvato nel nuovo calendario %s.","%n eventi sono stati salvati nel nuovo calendario %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n evento è stato salvato nel tuo calendario.","%n eventi sono stati salvati nel tuo calendario."),
"New Timezone:" => "Nuovo fuso orario:",
"Timezone changed" => "Fuso orario cambiato",
"Invalid request" => "Richiesta non valida",
"Calendar" => "Calendario",
"Error sending mail" => "Errore durante l'invio del messaggio",
"Deletion failed" => "Eliminazione non riuscita",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Vuoi davvero eliminare questo calendario?",
"group" => "gruppo",
...
"Contacts' birthdays CalDAV address" => "Indirizzo CalDAV dei compleanni del contatti",
