...
"events have been saved in the new calendar" => "події було збережено у новому календарі",
"Import failed" => "Імпорт не був виконаний",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n подія була збережена в новому календарі %s.","%n подій було збережено в новому календарі %s.","%n подій було збережено в новому календарі %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n подія була збережена у вашому календарі.","%n подій було збережено у вашому календарі.","%n подій було збережено у вашому календарі."),
"New Timezone:" => "Новий часовий пояс",
"Timezone changed" => "Часовий пояс змінено",
"Invalid request" => "Некоректний запит",
"Calendar" => "Календар",
"Error sending mail" => "Помилка відправки повідомлення",
"Deletion failed" => "Видалення не було виконано",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Ви дійсно бажаете видалити цей календар? ",
"group" => "група",
...
"Interval is not valid. It must be a positive integer!" => "Інтервал не діє. Він повинен бути позитивним цілим числом!",
"Import" => "Імпорт",
"Shared" => "Опубліковано",
"Error" => "Помилка",
...
"Contacts' birthdays CalDAV address" => "Адреса CalDAV днів народження контактів",
