...
"You do not have the permissions to edit this event." => "Du har ikkje tillating til å endra denne kalenderen.",
...
"by" => "av",
"unnamed" => "utan namn",
"You do not have the permissions to update this calendar." => "Du har ikkje ",
"You do not have the permissions to delete this calendar." => "Du har ikkje tillating til å sletta denne kalenderen.",
"You do not have the permissions to add to this calendar." => "Du har ikkje tillating til å leggja til i denne kalenderen.",
"You do not have the permissions to add events to this calendar." => "Du har ikkje tillating til å leggja til hendingar i denne kalenderen.",
"You do not have the permissions to delete this event." => "Du har ikkje tillating til å sletta denne hendinga.",
"Busy" => "Oppteken",
"Public" => "Offentleg",
"Private" => "Privat",
...
"A Calendar with this name already exists. If you continue anyhow, these calendars will be merged." => "Det finst alt ein kalender med dette namnet. Viss du går vidare uansett vil desse kalendrane bli føydde saman.",
