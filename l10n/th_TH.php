...
"events have been saved in the new calendar" => "กิจกรรมได้ถูกบันทึกไปไว้ในปฏิทินที่สร้างขึ้นใหม่แล้ว",
"Import failed" => "การนำเข้าข้อมูลล้มเหลว",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("มี %n เหตุการณ์ที่ถูกบันทึกไว้ในปฏิทินใหม่ %s"),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("มี %n เหตุการณ์ที่ถูกบันทึกไว้ในปฏิทินของคุณ"),
"New Timezone:" => "สร้างโซนเวลาใหม่:",
"Timezone changed" => "โซนเวลาถูกเปลี่ยนแล้ว",
"Invalid request" => "คำร้องขอไม่ถูกต้อง",
"Calendar" => "ปฏิทิน",
"Error sending mail" => "มีข้อผิดพลาดในการส่งอีเมล",
"Deletion failed" => "การลบทิ้งล้มเหลว",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "คุณแน่ใจที่จะลบปฏิทินนี้หรือไม่?",
...
"Interval is not valid. It must be a positive integer!" => "ช่วงเวลาผิดพลาด ต้องเป็นเลขจำนวนเต็มบวก!",
"Import" => "นำเข้าข้อมูล",
"Shared" => "แชร์แล้ว",
"Error" => "ข้อผิดพลาด",
...
"Contacts' birthdays CalDAV address" => "วันเกิดจากรายชื่อผู้ติดต่อ CalDAV",
...
"Visibility to people shared with" => "การมองเห็นสำหรับบุคคลที่คุณแบ่งปันด้วย",
