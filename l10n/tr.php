...
"events has been saved in the new calendar" => "etkinlik yeni takvime kaydedildi",
"Import failed" => "İçeri aktarma başarısız",
"events has been saved in your calendar" => "etkinlik takviminize kaydedildi",
...
"dddd M/d" => "d.M dddd",
"MMMM yyyy" => "MMMM yyyy",
"MMM d[ yyyy]{ '–'[ MMM] d yyyy}" => "d[ yyyy]{ '–'[ MMM] d MMM yyyy}",
