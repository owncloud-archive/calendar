...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n etkinlik yeni %s takvimine kaydedildi.","%n etkinlik yeni %s takvimine kaydedildi."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n etkinlik takviminize kaydedildi.","%n etkinlik takviminize kaydedildi."),
"New Timezone:" => "Yeni Zaman Dilimi:",
"Timezone changed" => "Zaman dilimi değiştirildi",
"Invalid request" => "Geçersiz istek",
"Calendar" => "Takvim",
"Error sending mail" => "Posta gönderilirken hata",
"Deletion failed" => "Silme başarısız oldu",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Bu takvimi gerçekten silmek istiyor musunuz?",
"group" => "grup",
...
"Contacts' birthdays CalDAV address" => "Kişi doğum günleri CalDAV adresi",
