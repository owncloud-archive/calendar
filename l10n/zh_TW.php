...
"Import failed" => "匯入失敗",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("行程已經存到您的行事曆了"),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n 活動已經存到您的行事曆了。"),
"New Timezone:" => "新時區：",
"Timezone changed" => "時區已變更",
"Invalid request" => "無效請求",
"Calendar" => "日曆",
"Error sending mail" => "寄送郵件錯誤",
"Deletion failed" => "移除失敗",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "您確定要刪除這個行事曆?",
"group" => "群組",
"can edit" => "可編輯",
"can share" => "可分享",
"ddd" => "ddd",
...
"Interval is not valid. It must be a positive integer!" => "區間是無效的。這必須是一個整數!",
"Import" => "匯入",
"Shared" => "已分享",
"Error" => "錯誤",
...
"Contacts' birthdays CalDAV address" => "連絡人的生日 CalDAV 位址",
"Share Calendar" => "分享日曆",
"Download" => "下載",
"Edit" => "編輯",
"Delete" => "刪除",
