OC.L10N.register(
    ...
    "_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" : ["o evento %n foi gravado no novo calendário %s.","os eventos %n foram salvos no novo calendário %s."],
    "_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" : ["o evento %n foi salvo no seu calendário.","os eventos %n foram salvos no seu calendário."],
