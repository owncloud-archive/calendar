...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n dogodek je bil shranjen v nov koledar %s.","%n dogodka sta bila shranjena v nov koledar %s.","%n dogodki so bili shranjeni v nov koledar %s.","%n dogodkov je bilo shranjenih v nov koledar %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n dogodek je bil shranjen v koledar.","% dogodka sta bila shranjena v koledar.","%n dogodki so bili shranjeni v koledar.","%n dogodkov je bilo shranjenih v koledar."),
"New Timezone:" => "Nov časovni pas:",
"Timezone changed" => "Časovni pas je spremenjen",
"Invalid request" => "Neveljavna zahteva",
"Calendar" => "Koledar",
"Error sending mail" => "Napaka pošiljanja sporočila",
"Deletion failed" => "Brisanje je spodletelo.",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd, d. MMMM [ yyyy]{ - [ddd, d.] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd. d. MMMM[ yyyy] HH:mm{ - [ ddd. d. MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Ali res želite izbrisati koledar?",
"group" => "skupina",
...
"Share" => "Souporaba",
"Share with people on other ownClouds using the syntax username@example.com/owncloud" => "Souporaba z uporabniki drugih oblakov ownCloud je mogoča s povezavo uporabnik@domena.si/owncloud",
