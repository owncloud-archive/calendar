<?php
$TRANSLATIONS = array(
"Not all calendars are completely cached" => "Tous les calendriers ne sont pas complètement mis en cache",
...
"events have been saved in the new calendar" => "événements ont été enregistrés dans le nouveau calendrier",
"Import failed" => "Échec de l'importation",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n événement a été enregistré dans le nouveau calendrier %s.","%n événements ont été enregistrés dans le nouveau calendrier %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n événement a été enregistré dans votre calendrier.","%n événements ont été enregistrés dans votre calendrier."),
"New Timezone:" => "Nouveau fuseau horaire :",
"Timezone changed" => "Fuseau horaire modifié",
"Invalid request" => "Requête non valable",
"Calendar" => "Calendrier",
"Error sending mail" => "Erreur lors de l'envoi du courriel",
"Deletion failed" => "La suppression a échoué",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Voulez-vous vraiment supprimer ce calendrier ?",
"group" => "groupe",
...
"Missing or invalid fields" => "Champs manquants ou non valables",
"Title" => "Titre",
...
"Contacts' birthdays CalDAV address" => "Adresse CalDAV des anniversaires des contacts",
