...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n hendelse ble lagret i den nye kalenderen %s.","%n hendelser ble lagret i den nye kalenderen %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n hendelse ble lagret i din kalender.","%n hendelser ble lagret i din kalender."),
"New Timezone:" => "Ny tidssone:",
"Timezone changed" => "Tidssone endret",
"Invalid request" => "Ugyldig forespørsel",
"Calendar" => "Kalender",
"Error sending mail" => "Feil ved sending av e-post",
"Deletion failed" => "Sletting feilet",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Vil du virkelig fjerne denne kalenderen?",
"group" => "gruppe",
"can edit" => "kan endre",
"can share" => "kan dele",
"ddd" => "ddd",
...
"Contacts' birthdays CalDAV address" => "CalDAV-adresse for kontakters bursdager",
