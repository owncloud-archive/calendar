...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n afspraak is opgeslagen in nieuwe agenda %s.","%n afspraken zijn opgeslagen in nieuwe agenda %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n afspraak is opgeslagen in uw agenda.","%n afspraken zijn opgeslagen in uw agenda."),
"New Timezone:" => "Nieuwe tijdzone:",
"Timezone changed" => "Tijdzone is veranderd",
"Invalid request" => "Ongeldige aanvraag",
"Calendar" => "Agenda",
"Error sending mail" => "Fout bij versturen mail",
"Deletion failed" => "Verwijderen mislukt",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "Wilt u deze agenda echt verwijderen?",
"group" => "groep",
...
"Contacts' birthdays CalDAV address" => "Contactpersonen geboortedata CalDAV adres",
...
"Not shared with anyone via calendar" => "Niet met iemand gedeeld via de agenda",
