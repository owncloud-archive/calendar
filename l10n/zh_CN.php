...
"events have been saved in the new calendar" => "事件已经保存在新日历中",
"Import failed" => "导入失败",
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("事件已经保存在新日历中"),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("事件已经保存在您的日历中"),
"New Timezone:" => "新时区：",
"Timezone changed" => "时区已修改",
"Invalid request" => "非法请求",
"Calendar" => "日历",
"Error sending mail" => "发送邮件失败",
"Deletion failed" => "删除失败",
"ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}" => "ddd d MMMM[ yyyy]{ - [ddd d] MMMM yyyy}",
"ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}" => "ddd d MMMM[ yyyy] HH:mm{ - [ ddd d MMMM yyyy] HH:mm}",
"Do you really want to delete this calendar?" => "确定要删除此日历?",
"group" => "群组",
"can edit" => "可编辑",
"can share" => "可共享",
"ddd" => "ddd",
...
"Interval is not valid. It must be a positive integer!" => "间隔无效，它必须是一个正整数！",
"Import" => "导入",
"Shared" => "已共享",
"Error" => "错误",
...
"Contacts' birthdays CalDAV address" => "联系人生日CalDAV 地址",
"Share Calendar" => "共享日历",
"Download" => "下载",
"Edit" => "编辑",
"Delete" => "删除",
...
"Location" => "地点",
"View on map" => "在地图上显示",
"Categories (separate by comma)" => "分类(逗号分隔)",
...
"End" => "结束",
"occurrences" => "次",
"Visibility to people shared with" => "好友是否可见",
...
"Create event" => "创建事件",
"Share with user or group" => "分享给其他用户或群组",
"Not shared with anyone" => "不与任何人共享",
"Send Email" => "发送邮件",
"Shared via calendar" => "通过日历分享",
"Not shared with anyone via calendar" => "不通过日历与任何人共享",
"View an event" => "查看事件",
"Category" => "分类",
