OC.L10N.register(
    ...
    "_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" : ["%n dogodek je bil shranjen v nov koledar %s.","%n dogodka sta bila shranjena v nov koledar %s.","%n dogodki so bili shranjeni v nov koledar %s.","%n dogodkov je bilo shranjenih v nov koledar %s."],
    "_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" : ["%n dogodek je bil shranjen v koledar.","% dogodka sta bila shranjena v koledar.","%n dogodki so bili shranjeni v koledar.","%n dogodkov je bilo shranjenih v koledar."],
