...
"_%n event has been saved in the new calendar %s._::_%n events have been saved in the new calendar %s._" => array("%n eventos han sido guardados en el nuevo calendario %s.","%n eventos han sido guardados en el nuevo calendario %s."),
"_%n event has been saved in your calendar._::_%n events have been saved in your calendar._" => array("%n eventos han sido guardados en su calendario.","%n eventos han sido guardados en su calendario."),
...
"Do you really want to delete this calendar?" => "¿Desea realmente eliminar este calendario?",
"group" => "grupo",
...
"Interval is not valid. It must be a positive integer!" => "El intervalo no es válido. Debe ser un número entero positivo.",
"Import" => "Importar",
"Shared" => "Compartido",
"Error" => "Error",
...
"Show only busy" => "Mostrar sólo cuando esté ocupado",
...
"A Calendar with this name already exists. If you continue anyhow, these calendars will be merged." => "Un calendario con este nombre ya existe. Si aun así continúa, estos calendarios se combinarán.",
